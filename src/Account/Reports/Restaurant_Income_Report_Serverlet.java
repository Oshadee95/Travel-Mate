 ...
 * @author Redhw
 */
@WebServlet(name = "Restaurant_Income_Report_Serverlet", urlPatterns = {"/Restaurant_Income_Report_Serverlet"})
public class Restaurant_Income_Report_Serverlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                //Report name (pdf)
                String fileName = "restaurant-income-report";
