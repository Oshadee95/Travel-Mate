...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="Home.jsp" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">MERCH</a>
	...
	<i style='font-size:48px' class='fas'>&#xf594;</i><h4><font color ="#00cc7a"><font size="6">Hotel,Restaurant & Resort  Registration</font></font></h4>
                   ...
                   <p><textarea name="rooms" rows="10" cols="30" ></textarea></p>
                             ...
                             <label>Hall Capacity & Name</label>
                                <p><input type="text" class="form-control"  name="hall" placeholder="Hall"></p>
