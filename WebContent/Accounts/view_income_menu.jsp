        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="w3-panel">
                <div class="w3-row w3-margin-top" style="margin-left: 150px; margin-top: 10% !important">
                    <a href="<%= request.getContextPath()%>/Accounts/view_income_statement.jsp">
                    ...
                    <div class="w3-rest">
                        <div class="w3-row w3-margin-left">
                            <a href="<%= request.getContextPath()%>/Accounts/view_hotel_income.jsp">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_restaurant_income.jsp">
                                <div class="w3-col s3 w3-margin-right">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_guide_income.jsp">
                                <div class="w3-col s3">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_adventure_places_income.jsp">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_traveling_places_income.jsp">
                                <div class="w3-col s3 w3-margin-right w3-margin-top">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_spa_income.jsp">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_vehicle_income.jsp">
                                <div class="w3-col s3 w3-margin-right w3-margin-top">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_driver_income.jsp">
                                <div class="w3-col s3 w3-margin-right w3-margin-top">
                            ...
                            <a href="<%= request.getContextPath()%>/Accounts/view_packages_income.jsp">
                                <div class="w3-col s3 w3-margin-right w3-margin-top">
                                    <div class="w3-container w3-khakish w3-border w3-border-khakish w3-hover-white w3-hover-text-khakish w3-text-white w3-padding-24">
