            ...
            <div class="w3-panel">
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-rest w3-right">
                        <form action="<%=request.getContextPath()%>/Spa_Income_Report_Serverlet" method="POST">
                    ...
                    <div class="w3-col w3-center">
                        ...
                        <table id="datatable" class="display table table-data-width w3-table w3-bordered w3-white">
                            ...
                            <tbody>
                                <%
                                    ResultSet res06;
                                    res06 = Income_Statement.getDepartmentTransactions("Spa");
                                    while (res06.next()) {
                                %>
