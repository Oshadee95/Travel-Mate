...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar">
            ...
            <a href="<%= request.getContextPath()%>/login.jsp" class="w3-bar-item w3-btn"><i class="fa fa-sign-out-alt"></i></a>
        </div>
    </div>
    ...
    <div class="w3-bar-block w3-padding-24">
        ...
        <a href="<%= request.getContextPath()%>/view_reports.jsp" class="w3-bar-item w3-button w3-padding w3-hover-blue"><i class="fa fa-file-contract fa-fw"></i>&nbsp; Reports</a>
