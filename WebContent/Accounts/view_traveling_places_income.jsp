        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="w3-panel w3-steel-gray" style="margin-bottom:40px !important">
                <header class="w3-container" >
                    <h6>Dashboard / Income / Traveling Places</h6>
                </header>
            </div>
            ...
            <div class="w3-panel">
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-rest w3-right">
                        <form action="<%=request.getContextPath()%>/Traveling_Places_Income_Report_Serverlet" method="POST">
                    ...
                    <div class="w3-col w3-center">
                        ...
                        <table id="datatable" class="display table table-data-width w3-table w3-bordered w3-white">
                            ...
                            <tbody>
                                <%
                                    ResultSet res06;
                                    res06 = Income_Statement.getDepartmentTransactions("Traveling");
                                    while (res06.next()) {
                                %>
