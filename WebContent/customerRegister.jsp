...
<input type="submit" value="Next" />
	...
	<i style='font-size:48px' class='fas'>&#xf3c5;</i><a href="tourGuideRegister.jsp"><font size="5">Register As A Tour Guide</font></p></a>
		<font size="5">Register As A Owner</font></p>
			...
			<li><i style='font-size:48px' class='fas'>&#xf236;</i><a href="test5.jsp" style="font-size: 20px">Spa..</a></li><br/>			
			<li><i style='font-size:48px' class='fas'>&#xf594;</i><a href="test2.jsp" style="font-size: 20px">Hotel & Resort..</a></li><br/>
